...
//        });
    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MapPlaceActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (status.equals("OK")) {
                        ...
                        // Zero results found
                        aLert.showAlertDialog(MapPlaceActivity.this, "Near Places",
                                "Sorry no places found. Try to change the types of places",
                                false);
                    } else if (status.equals("UNKNOWN_ERROR")) {
                        aLert.showAlertDialog(MapPlaceActivity.this, "Places Error",
    ...
    private void aboutVersion() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MapPlaceActivity.this);
